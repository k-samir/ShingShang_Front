...
public class Game {
	...
	/**
	 * Cr�er un plateau et l'affecte � l'attribut board du jeu
	 */
	...
	/**
	 * D�marre le jeu et g�re le d�roulement de jeu
	 */
	public void start() {
		showName();
		createBoard();
	...
	/**
	 * Indique si le jeu n'est pas termin�
	 * 
	...
	/**
	 * Indique si le jeu est termin� en recherchant le nom du gagnant
	 * 
	...
	public void playTurn() {
		...
		board.show();
		System.out.println(turnPlayer.getName() + ", � toi de jouer ! :)");
		selectedBushi = Console.askChoseBushi(this);
		System.out.println("Pi�ce s�l�ctionn�e : " + selectedBushi.toString());
	...
	/**
	 * G�re le d�roulement d'un tour suppl�mentaire lors d'un shing shang
	 */
	public void playAdditionnalTurn() {
		...
		while (playerWantsToContinue && board.isAdditionalTurn()) {
			board.show();
			System.out.println(turnPlayer.getName() + ", tu peux choisir une autre pi�ce :)");
			selectedBushi = Console.askChoseBushi(this);
			System.out.println("Pi�ce s�l�ctionn�e : " + selectedBushi.toString());
			selectedBushi.calculateLegalMoves();
	...
	/**
	 * Passe au tour suivant et d�termine le joueur du tour
	 */
	 ...
	 * 
	 * @param p un joueur
	 * @return true si le joueur du tour est diff�rent du joueur du tour
	 */
